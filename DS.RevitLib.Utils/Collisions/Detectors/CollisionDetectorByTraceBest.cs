...
namespace DS.RevitLib.Utils.Collisions.Detectors
{
    ...
    /// </summary>
    public class CollisionDetectorByTraceBest : ITraceCollisionDetector<Point3d>
    {
        ...
        public CollisionDetectorByTraceBest(Document doc, MEPCurve baseMEPCurve, ITraceSettings traceSettings, bool insulationAccount,
