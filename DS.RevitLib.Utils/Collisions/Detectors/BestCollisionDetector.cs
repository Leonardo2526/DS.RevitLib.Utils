...
namespace DS.RevitLib.Utils.Collisions.Detectors
{
    ...
    /// </summary>
    public class BestCollisionDetector : IElementCollisionDetector
    {       
        ...
        public BestCollisionDetector(Document activeDocument, IElementIntersectionFactory intersectionFactory,
        ...
        {
            get => _activeDocElements ?? ElementsExtractor.GetFromDoc();
        ...
        {
            get => _linkElements ?? ElementsExtractor.GetFromLinks();
            private set => _linkElements = value;
        }
        ...
        private IElementsExtractor ElementsExtractor =>
            _elementsExtractor ??= new ElementsExtractor(_activeDocument);
