...
{
    public class OldMEPSystemGraphFactory : MEPSystemGraphFactoryBase<AdjacencyGraph<LVertex, Edge<LVertex>>>
    {

        public OldMEPSystemGraphFactory(Document doc) : base(doc)
        {
        }
